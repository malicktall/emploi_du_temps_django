    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enseignant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enseignant', to=settings.AUTH_USER_MODEL)),
                ('filiere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.filiere')),
                ('matiere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.matiere')),
                ('promo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.promo')),
        ...
        migrations.AddField(
            model_name='user',
            name='departements',
            field=models.ManyToManyField(blank=True, to='myApp.departement'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
